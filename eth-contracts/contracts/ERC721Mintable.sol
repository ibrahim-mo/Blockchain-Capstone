...
contract Ownable is Context {
    ...
    constructor() internal {
        _owner = _msgSender();
        emit OwnershipTransfer(address(0), _msgSender());
    }

    modifier onlyOwner() {
        require(_msgSender() == _owner, "Sender is not contract owner");
        _;
    }
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != owner, "ERC721: token owner cannot approve to self");
    ...
    function setApprovalForAll(address to, bool approved) public {
        require(to != _msgSender(), "ERC721: caller cannot set approval to self");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(!_exists(tokenId), "ERC721: existing token");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == ownerOf(tokenId), "ERC721: transfer caller is not owner");
...
contract ERC721Enumerable is ERC165, ERC721 {
    ...
    function tokenOfOwnerByIndex(address owner, uint256 index) public view returns (uint256) {
        require(index < balanceOf(owner), "ERC721Enumerable: invalid token index for owner");
    ...
    function tokenByIndex(uint256 index) public view returns (uint256) {
        require(index < totalSupply(), "ERC721Enumerable: invalid token index");
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function tokenURI(uint256 tokenId) external view returns (string memory) {
        require(_exists(tokenId), "ERC721Metadata: non-existing token");
...
/**
 * RealStateToken is an ERC721 contract that's suitable for "OpenSea Whitelisting".
 * Snippets of the following code as well as the files under './common/meta-transactions' are
 * modified from OpneSea's ERC721 tutorial to work with solidity ^0.5.0 and 'ERC721Metadata'.
 */
...
/**
 * @title RealStateToken
 * ERC721 contract that whitelists a trading address, and has minting functionality.
 */
contract RealStateToken is ContextMixin, Ownable, ERC721Metadata, NativeMetaTransaction {
    string private constant NAME = "Real State Token";
    string private constant SYMBOL = "RST";
    ...
    ) ERC721Metadata(NAME, SYMBOL, BASE_TOKEN_URI) public {
